...
- `assets/video/` — five 12-second 1080p clips of American architecture (H.264, ~1.5–3 MB each)
...
Of the user's original eight-building wishlist, the American Radiator Building was
skipped by request, and the Fisher Building (Detroit), Gulf Tower (Pittsburgh), and
